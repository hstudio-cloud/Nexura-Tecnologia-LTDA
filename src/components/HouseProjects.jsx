...
const WA_LINK = 'https://wa.me/5584997070028?text=Ol%C3%A1%2C%20vim%20pelo%20site%20da%20Nexura%20e%20quero%20saber%20sobre%20projetos%20de%20casas.'
  ...
  return (
    <section id="casas" className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 70% 60% at 10% 60%, rgba(245,158,11,0.05) 0%, transparent 60%)' }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <span className="section-label mb-4 block" style={{ color: '#f59e0b' }}>
              <span style={{ background: '#f59e0b', display: 'inline-block', width: '20px', height: '1px', marginRight: '8px' }} />
              Projetos residenciais
            </span>

            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-800 leading-tight mb-6"
          ...
          >
            <div className="card-glass rounded-2xl p-8 border"
              style={{ borderColor: 'rgba(245,158,11,0.15)' }}>
              <h3 className="font-display text-lg font-700 text-white mb-6" style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700 }}>
              ...
              <ul className="space-y-4">
                {items.map((item, i) => (
                  ...
                  >
                    <CheckCircle size={18} className="flex-shrink-0 mt-0.5" style={{ color: '#f59e0b' }} />
              ...
              <div className="mt-8 p-4 rounded-xl flex items-start gap-3"
                ...
                <AlertCircle size={16} className="flex-shrink-0 mt-0.5" style={{ color: '#f59e0b', opacity: 0.7 }} />
