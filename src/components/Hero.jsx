...
import { ArrowUpRight, Globe, Home, Users, Zap, ChevronDown } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 80% 60% at 50% -5%, rgba(0,229,255,0.10) 0%, transparent 60%)',
        }}
      />
      <div
      ...
      <div className="absolute bottom-1/3 right-1/4 w-80 h-80 rounded-full opacity-[0.06] blur-3xl"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-28 pb-20 lg:pt-36 lg:pb-24 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Sites, captação de clientes e projetos que{' '}
              <span className="text-gradient">tiram sua ideia do papel.</span>
            </motion.h1>
            ...
            >
              ...
              residenciais para clientes em{' '}
              <span className="text-white/80 font-medium">Assú/RN e região.</span>
            </motion.p>
          ...
          <div className="relative hidden lg:block h-[500px]">
            ...
            >
              ...
              <div className="relative z-10 text-center p-8">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl border border-nexura-cyan/20 bg-nexura-cyan/5 mb-4">
                  <Zap size={36} className="text-nexura-cyan" />
                </div>
                <p className="font-display text-xl font-700 text-white/90" style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700 }}>
                  Da ideia ao<br />resultado
                </p>
            ...
            {floatingCards.map((card, i) => (
              ...
              >
                <div className="card-glass rounded-xl px-4 py-3 flex items-center gap-3 min-w-[180px] shadow-2xl"
